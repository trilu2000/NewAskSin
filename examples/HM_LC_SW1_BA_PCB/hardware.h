...
#define _HARDWARE_h
	...
	//- cc1100 hardware CS and GDO0 definitions -------------------------------------------------------------------
	#define COM_CS                 PIN_B4									// chip select
	#define COM_GDO0               PIN_B5									// GDO0 pin, identify data received on falling edge
	#define COM_MISO               PIN_B3									// SPI port MISO
	#define COM_MOSI               PIN_B2									// SPI port MOSI
	#define COM_SCLK               PIN_B1									// SPI port Clock
