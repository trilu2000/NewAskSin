...
class cmBlind {
  ...
  private://---------------------------------------------------------------------------------------------------------------
	...
	struct s_lstPeer {
	 ...
	 /*
	  * Contains all register from list 1 without short or long prefix
	  */
	struct s_l3 {
  ...
  //- user defined functions ----------------------------------------------------------------------------------------------
	...
	void     trigger41(uint8_t msgLong, uint8_t msgCount, uint8_t msgVal);					// messages coming from sensor
